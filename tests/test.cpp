...
TEST_CASE("Shortest Path of Flights1", "[mock graph used]") {
...
TEST_CASE("Shortest Path of Flights2", "[test file used]") {
...
TEST_CASE("test", "[mock graph used]") {
  ...
  basic_graph.addEdge("A", "B", 4, 0, 0);
  basic_graph.addEdge("A", "C", 8, 0, 0);
  basic_graph.addEdge("B", "D", 6, 0, 0);
  basic_graph.addEdge("C", "E", 2, 0, 0);
  basic_graph.addEdge("C", "B", 3, 0, 0);
  basic_graph.addEdge("D", "E", 10, 0, 0);
